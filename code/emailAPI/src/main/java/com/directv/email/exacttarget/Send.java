    ...
    extends APIObject
{
    ...
    protected java.util.List<com.directv.email.exacttarget.List> list;
     ...
     * 
     */
    public java.util.List<com.directv.email.exacttarget.List> getList() {
        if (list == null) {
            list = new ArrayList<com.directv.email.exacttarget.List>();
        }
        return this.list;
    }
