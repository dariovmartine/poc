...
import com.directvla.schema.util.commonexceptions.v1_0.AccessDeniedException;
import com.directvla.schema.util.commonexceptions.v1_0.EntityAlreadyExistsException;
import com.directvla.schema.util.commonexceptions.v1_0.EntityInUseException;
import com.directvla.schema.util.commonexceptions.v1_0.EntityNotFoundException;
import com.directvla.schema.util.commonexceptions.v1_0.InternalErrorException;
import com.directvla.schema.util.commonexceptions.v1_0.InvalidParameterValueException;
import com.directvla.schema.util.commonexceptions.v1_0.InvalidQueryParameterException;
import com.directvla.schema.util.commonexceptions.v1_0.InvalidRequestException;
import com.directvla.schema.util.commonexceptions.v1_0.InvalidResponseException;
import com.directvla.schema.util.commonexceptions.v1_0.InvalidSecurityTokenException;
import com.directvla.schema.util.commonexceptions.v1_0.MissingParameterException;
import com.directvla.schema.util.commonexceptions.v1_0.OperationNotYetImplementedException;
import com.directvla.schema.util.commonexceptions.v1_0.ServiceUnavailableException;
...
@XmlRootElement(name = "AddCustomerAccountProductInvolvementWithResourceException")
public class AddCustomerAccountProductInvolvementWithResourceException {
