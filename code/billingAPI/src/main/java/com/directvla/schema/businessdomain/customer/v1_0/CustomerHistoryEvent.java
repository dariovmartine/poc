 ...
 *         &lt;element name="ExternalAgentId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CustomerHistoryEvent", propOrder = {
    "customerKey",
    "id",
    "userNr",
    "userKey",
...
public class CustomerHistoryEvent {
    ...
    @XmlElement(name = "ExternalAgentId")
    ...
    /**
     * Gets the value of the externalAgentId property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the externalAgentId property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
