...
@XmlRootElement(name = "GetCustomerFinancialTransactionsByCriteriaException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
public class GetCustomerFinancialTransactionsByCriteriaException {

    @XmlElement(name = "EntityAlreadyExistsException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected EntityAlreadyExistsException entityAlreadyExistsException;
    @XmlElement(name = "EntityNotFoundException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected EntityNotFoundException entityNotFoundException;
    @XmlElement(name = "EntityInUseException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected EntityInUseException entityInUseException;
    @XmlElement(name = "InternalErrorException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected InternalErrorException internalErrorException;
    @XmlElement(name = "MissingParameterException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected MissingParameterException missingParameterException;
    @XmlElement(name = "InvalidParameterValueException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected InvalidParameterValueException invalidParameterValueException;
    @XmlElement(name = "InvalidQueryParameterException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected InvalidQueryParameterException invalidQueryParameterException;
    @XmlElement(name = "InvalidRequestException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected InvalidRequestException invalidRequestException;
    @XmlElement(name = "InvalidResponseException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected InvalidResponseException invalidResponseException;
    @XmlElement(name = "InvalidSecurityTokenException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected InvalidSecurityTokenException invalidSecurityTokenException;
    @XmlElement(name = "AccessDeniedException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected AccessDeniedException accessDeniedException;
    @XmlElement(name = "ServiceUnavailableException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
    protected ServiceUnavailableException serviceUnavailableException;
    @XmlElement(name = "OperationNotYetImplementedException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
