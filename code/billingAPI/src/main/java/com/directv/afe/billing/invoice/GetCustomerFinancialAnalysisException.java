...
@XmlRootElement(name = "GetCustomerFinancialAnalysisException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
public class GetCustomerFinancialAnalysisException {
