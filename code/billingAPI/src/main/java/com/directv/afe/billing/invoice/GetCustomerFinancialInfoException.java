...
@XmlRootElement(name = "GetCustomerFinancialInfoException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
public class GetCustomerFinancialInfoException {
