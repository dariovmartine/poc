...
@XmlRootElement(name = "GetCustomerFinancialTransactionException", namespace = "http://directvla.com/schema/businessdomain/ManageBillingEvents/v1-0")
public class GetCustomerFinancialTransactionException {
